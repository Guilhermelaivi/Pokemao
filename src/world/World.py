...
colorInitialPokemao = colorPokemao(initialPokemao.name.value)
print(f"Mestre pokemão {player.name}, seu pokemão inicial é: " + f"{colorInitialPokemao} {initialPokemao.name.value}")
